...
class TestProfileModels(TestCase):
    ...
    def setUp(self):
        ...
        self.user.userprofile.default_city = "Test Town"
        ...
        self.user.userprofile.default_phone = "1234567890"
    ...
    def test_profile_info(self):
        ...
        self.assertEqual(profile.default_city, 'Test Town')
        ...
        self.assertEqual(profile.default_phone, '1234567890')
